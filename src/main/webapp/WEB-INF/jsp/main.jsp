        ...
        <div class="hrms_main_ad col-sm-10">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 style="text-align: center;">欢迎进入学生信息后台管理系统！</h3>
                </div>
                    ...
                    <div id="hrms_carousel_1" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active" style="text-align: center;">
                                <img class="img-responsive center-block" src="/static/img/Campus1.jpg" alt="Campus1">
                                <div class="carousel-caption">
                                    <h3>校园风光一</h3>
                                </div>
                            </div>
                            <div class="item">
                                <img class="img-responsive center-block" src="/static/img/Campus2.jpg" alt="Campus2">
                                <div class="carousel-caption">
                                    <h3>校园风光二</h3>
                                </div>
                            </div>
                            <div class="item">
                                <img class="img-responsive center-block" src="/static/img/Campus3.jpg" alt="Campus3">
                                <div class="carousel-caption">
                                    <h3>校园风光三</h3>
                                </div>
                            </div>
